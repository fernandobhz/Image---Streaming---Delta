...
Module ScreenHandleMyDiffThumb

    Function RecordScreenMyDiffThumb(Seconds As Integer, File As String) As Integer
        Dim tStart As DateTime = Now
        Dim tStop As DateTime = DateAdd(DateInterval.Second, Seconds, tStart)

        Dim X As New List(Of Byte())

        Dim InitialScreenShot As Bitmap = TakeScreenShotThumb()
        ...
        While Now < tStop
            ...
            Dim LadoB As Byte() = TakeScreenShotBmpThumb()
    ...
    Sub PlayRecordedScreenMyDiffThumb(File As String, PictureBox As PictureBox)
