...
Module ScreenHandleXorDeflate

    Function RecordScreenXorDeflate(Seconds As Integer, File As String) As Integer
        ...
        While Now < tStop
            ...
            Dim Delta As Byte() = DeflateMax(ByteArrayXor(LadoA, LadoB))
    ...
    Sub PlayRecordedScreenXorDeflate(File As String, PictureBox As PictureBox)
        ...
        For i As Integer = 1 To X.Count - 1
            NewImage = ByteArrayXor(Inflate(X(i)), NewImage)
